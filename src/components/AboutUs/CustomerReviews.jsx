...
const CustomerReviews = () => {
  return (
    ...
    <div className=" mt-10 mb-10">
      ...
      <p className="m-auto mt-4 max-w-lg  text-center info-text text-lg">Hear genuine stories from our satisfied customers about their exceptional experiences with us.</p>
